...
public class QuestionC {
    ...
    public QuestionC(double lambda1,double lambda2, 
    ...
    class Arrival extends Event{
		...
		public void actions() {
	      ...
	      { 
	    	  ...
	    	  cust.type=1;
		      if (agentsLibres1.size()==0 && agentsLibres2.size()<=s2) { 
		    	 System.out.println("agentslibres2.. "+agentsLibres2.size());
		         waitList1.addLast (cust);
		         totWait1.update (waitList1.size());
		         
		      } 
		      //else if(agentsLibres1.isEmpty() && !agentsLibres2.isEmpty()) {
		       else if(agentsLibres1.size()==0 && agentsLibres2.size()>s2) {
		    	   //System.out.println("agentslibres2.... "+agentsLibres2.size());
		    	 ...
		    	 //System.out.println("agentslibres1.. "+agentsLibres2.size());
	   ...
	   if(type==2)
	      { 
		      ...
		      cust.type=2;
		      if (agentsLibres1.size()<=s1 && agentsLibres2.size()==0) { 
		    	  // Must join the queue.
		    	  System.out.println("agentslibres1.. "+agentsLibres2.size());
		       ...
		       else if(agentsLibres1.size()>s1 && agentsLibres2.isEmpty()) {
		    	   System.out.println("agentslibres11.. "+agentsLibres2.size());
		    	   Agent agent = agentsLibres1.removeFirst();
		    	   Call call= new Call(cust, agent);
		    	   call.tempsDattente = Sim.time()-call.client.arrivTime;
		    	   verifCall(call);
		    	   ...
		    	   System.out.println("agentslibres22.. "+agentsLibres2.size());
		    	   // Starts service.
		    	   Agent agent = agentsLibres2.removeFirst();
		    	   Call call= new Call(cust, agent);
		    	   call.tempsDattente = Sim.time()-call.client.arrivTime;
...
public class EndOfSim extends Event {
	...
	public static void main (String[] args) {
			...
			QuestionC queue = new QuestionC(lambda1, lambda2, 
						mu11, mu12 
						,mu21, mu22, 
						nu1, nu2,
						agents1, agents2,
						s1,s2);
			queue.simulateNDay (5,28800.0);
			...
			System.out.println(tauxDoccupation1.report());
